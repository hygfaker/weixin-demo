...
public class IWxPublicServiceImpl implements IWxPublicService {
    ...
    public boolean delete(WxPublic wxPublic) throws WxErrorException, IOException {
        ...
        ValidatorUtil.entityValidator(wxPublic, validator, "publicCode");
...
//            }
    ...
    public boolean deleteBatch(WxPublic wxPublic) throws WxErrorException, IOException {
        ValidatorUtil.entityValidator(wxPublic, validator, "publicCodes");
        String[] publicCodes = wxPublic.getPublicCodes();
        return wxPublicDao.deleteBatch(publicCodes) > 0 ? true : false;
    }
    ...
    public boolean forceDeleteBatch(WxPublic wxPublic) throws WxErrorException, IOException {
        ValidatorUtil.entityValidator(wxPublic, validator, "publicCodes");
        String[] publicCodes = wxPublic.getPublicCodes();
        return wxPublicDao.forceDeleteBatch(publicCodes) > 0 ? true : false;
    }
