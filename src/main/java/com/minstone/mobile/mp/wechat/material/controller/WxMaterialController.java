package com.minstone.mobile.mp.wechat.material.controller;
...
public class WxMaterialController {
    ...
    public CommonResult mediaImgUpload(@RequestParam MultipartFile img) throws WxErrorException, IOException {
        ...
        WxMediaImgUploadResult result = wxService.getMaterialService().mediaImgUpload(file);
        // 上传成功后删除临时文件
        file.delete();
    ...
    public CommonResult uploadMedia(@RequestParam String mediaType,
        ...
        WxMpMaterialUploadResult result = wxService.getMaterialService().materialFileUpload(mediaType,mpMaterial);
        return ResultUtil.success(result);
    }
    ...
    public CommonResult materialNewsInfo(@RequestParam String mediaid) throws WxErrorException {
         return ResultUtil.success(wxService.getMaterialService().materialNewsInfo(mediaid));
    }
    ...
    public ResponseEntity<byte[]> newsOrVoiceDownload(@RequestParam String mediaid) throws Exception {
        InputStream inputStream = wxService.getMaterialService().materialImageOrVoiceDownload(mediaid);
