...
-- -----------------------------------------------------
-- Table `mdweixin`.`MP_YY_PUB_FLAG`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mdweixin`.`MP_YY_PUB_FLAG` (
  `CONFIG_CODE` VARCHAR(255) NOT NULL COMMENT '主键',
  `PUBLIC_CODE` VARCHAR(255) NOT NULL COMMENT '公众号主键',
  `MENU_USE_FLAG` INT(11) NOT NULL DEFAULT 0 COMMENT '是否开启自定义菜单。0为关闭，1为开启。',
  `KEFU_USE_FLAG` INT(11) NOT NULL DEFAULT 0 COMMENT '消息管理中是否开启客服服务。0为关闭，1为开启。',
  `PUSH_USE_FLAG` INT(11) NOT NULL DEFAULT 0 COMMENT '是否开启定点推送。0为关闭，1为打开。',
  `KEFU_OFFLINE_MESSAGE` VARCHAR(255) NOT NULL DEFAULT '客服为您服务' COMMENT '客服不在线的时候的提示内容',
  `KEFU_ONLINE_MESSAGE` VARCHAR(255) NOT NULL DEFAULT '服务结束' COMMENT '客服在线等时候的提示内容',
