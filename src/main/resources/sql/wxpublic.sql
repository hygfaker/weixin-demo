...
CREATE TABLE IF NOT EXISTS `mdweixin`.`MP_YY_PUB_CONFIG` (
  ...
  `MENU_USE_FLAG` INT(11) NULL DEFAULT 0 COMMENT '是否开启自定义菜单。0为关闭，1为开启。',
  `KEFU_USE_FLAG` INT(11) NULL DEFAULT 0 COMMENT '消息管理中是否开启客服服务。0为关闭，1为开启。',
  `PUSH_USE_FLAG` INT(11) NULL DEFAULT 0 COMMENT '是否开启定点推送。0为关闭，1为打开。',
  `KEFU_OFFLINE_MESSAGE` VARCHAR(255) NULL DEFAULT '您好，请问有什么可以帮到您！' COMMENT '客服不在线的时候的提示内容',
  `KEFU_ONLINE_MESSAGE` VARCHAR(255) NULL DEFAULT '抱歉，客服暂时不在，请留言。' COMMENT '客服在线等时候的提示内容',
...
CREATE TABLE IF NOT EXISTS `mdweixin`.`MP_YY_REP_RULE` (
  ...
  `USE_FLAG` INT(11) NOT NULL DEFAULT 1 COMMENT '关键词回复中规则是否开启。0为关闭，1为开启。',
  `KEFU_REPLY_FLAG` INT(11) NOT NULL DEFAULT 0 COMMENT '客服回复',
...
CREATE TABLE IF NOT EXISTS `mdweixin`.`MP_YY_REP_KEYWORD` (
  ...
  `DEL_FLAG` INT(11) NULL DEFAULT 0 COMMENT '是否删除。0为已删除，1为没删除。',
...
CREATE TABLE IF NOT EXISTS `mdweixin`.`MP_YY_MSG` (
  ...
  `DEL_FLAG` INT(11) NULL DEFAULT 0 COMMENT '是否删除。0为没删除，1为已删除、',
  `MSG_FLAG` INT(11) NULL DEFAULT 0 COMMENT '消息回复状态，0表示未回复状态，1表示回复状态',
